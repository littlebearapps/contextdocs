...
# Skill activation testing for ContextDocs plugin.
...
#   - jq installed
#   - ContextDocs plugin installed (or run from ContextDocs project directory)
#
...
echo "=== ContextDocs Skill Activation Test ==="
